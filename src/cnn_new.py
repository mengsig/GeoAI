...
val_predictions = evaluate_on_images(model, features[-1:], labels[-1:], patch_size, device)
...
axes[1].set_title('CNN Cell-wise Predictions')
...
plt.title('CNN Cell-wise Predictions vs Ground Truth')
